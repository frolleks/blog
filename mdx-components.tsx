...
const components = {
  h1: (props: HeadingProps) => (
    <h1
      className="font-semibold pt-12 mb-0 text-3xl font-mono text-cyan-600 [text-shadow:0_0_6px_rgb(8,145,178)] dark:text-cyan-400 dark:[text-shadow:0_0_8px_rgb(59,130,246)]"
      {...props}
    />
  ),
